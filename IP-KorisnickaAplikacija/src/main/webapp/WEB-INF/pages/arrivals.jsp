...
<body class="text-white" onload='getTodayArrivalsFligths()'
	onunload="clear()">
	...
	<div class="flex-container">
			...
			<div class="row">
				<div class="col-12">
					<div class="d-flex justify-content-center">
						<h4 class="col-10">
							<strong>Dolasci&nbsp;</strong><strong id="day">danas</strong>
						</h4>
		...
		<div class="container">
			<button class="btn btn-primary float-start" id="yesterday"
				onclick="getYesterdayArrivalsFligths()">&lt;Juce</button>
			<button class="btn btn-primary float-end" id="tomorrow"
				onclick="getTomorrowArrivalsFligths()">Sutra&gt;</button>
		</div>
	</div>
